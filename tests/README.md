...
- `integration/group-booking-flow.sh` holds two seats, assigns two passenger snapshots, creates one group, takes one sandbox payment, and verifies two active tickets.
