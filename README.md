...
This repository contains the core implementation plus its planning and architecture documentation. Complete submission placeholders and interview talking points are in [submission notes](docs/submission-notes.md).
