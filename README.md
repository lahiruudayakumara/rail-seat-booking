...
This repository currently delivers the planning and architecture phase only; it intentionally contains no application source code. Demo distances and fares are illustrative, not official Sri Lanka Railways data. Complete submission placeholders and interview talking points are in [submission notes](docs/submission-notes.md).
